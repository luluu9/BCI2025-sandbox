...
def get_brainbot_datasets(subjects=10, max_trials=4, brainbot_intervals=[[0.0, 2.5]], rest_vs_mi=False):
    brainbot_datasets = []
    for interval in brainbot_intervals:
        bb_ds = get_brainbot_dataset(interval=interval, rest_vs_mi=rest_vs_mi)
